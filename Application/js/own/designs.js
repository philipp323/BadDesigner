...
async function showGrundriss(){
  console.log("showGrundriss");

  $('#' + 1 + 'Text').css("font-size", $('#' + 1 + 'Image').width() / 6 + 'px');
  ANIMATING = true;
  // await Sleep(3000);
  //toShow.floor.visible = true;
  //await Sleep(1000);
  await Sleep(5000);
  if ($('#tutorial').css('display') == 'none' && document.readyState === "complete")
  {
...
function setup() {
  objectsAll = [{
    id: 1,
    numberOfModels: 33,
    textures: [{id: 1, name: 'V1_SanMod_Nature', displayName: 'NATURE', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 2, name: 'V1_SanMod_Nomad', displayName: 'NOMAD', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 3, name: 'V1_SanMod_Stripes', displayName: 'STRIPES', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 4, name: 'V1_SanMod_Woods', displayName: 'INTO THE WOODS', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 5, name: 'V1_SanMod_Industrial', displayName: 'INDUST-\nRIAL', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 6, name: 'V1_SanMod_Bricks', displayName: 'BUILD\nYOUR\nBRICKS', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 7, name: 'V1_SanMod_Violet', displayName: 'DREAM\nIN\nVIOLET', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 8, name: 'V1_SanMod_Mind', displayName: 'FREE\nYOUR\nMIND', generatedTextureObjects: undefined, objectsToHide: undefined}],
    objects: [],
    detailViews: [{id: 0,
    ...
    id: 2,
    numberOfModels: 30,
    textures: [{id: 1, name: 'V2_SanMod_Nature', displayName: 'NATURE', generatedTextureObjects: undefined, objectsToHide: undefined},
    ...
    {id: 5, name: 'V2_SanMod_Industrial', displayName: 'INDUST-\nRIAL', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 6, name: 'V2_SanMod_Bricks', displayName: 'BUILD\nYOUR\nBRICKS', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 7, name: 'V2_SanMod_Violet', displayName: 'DREAM\nIN\nVIOLET', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 8, name: 'V2_SanMod_Mind', displayName: 'FREE\nYOUR\nMIND', generatedTextureObjects: undefined, objectsToHide: undefined}],
    objects: [],
    detailViews: [
      {id: 0,
    ...
    id: 3,
    numberOfModels: 29,
    textures: [{id: 1, name: 'V3_SanMod_Nature', displayName: 'NATURE', generatedTextureObjects: undefined, objectsToHide: undefined},
    ...
    {id: 5, name: 'V3_SanMod_Industrial', displayName: 'INDUST-\nRIAL', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 6, name: 'V3_SanMod_Bricks', displayName: 'BUILD\nYOUR\nBRICKS', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 7, name: 'V3_SanMod_Violet', displayName: 'DREAM\nIN\nVIOLET', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 8, name: 'V3_SanMod_Mind', displayName: 'FREE\nYOUR\nMIND', generatedTextureObjects: undefined, objectsToHide: undefined}],
    objects: [],
    detailViews: [
      {id: 0,
    ...
    id: 4,
    numberOfModels: 34,
    textures: [{id: 1, name: 'V4_SanMod_Nature', displayName: 'NATURE', generatedTextureObjects: undefined, objectsToHide: undefined},
    ...
    {id: 5, name: 'V4_SanMod_Industrial', displayName: 'INDUST-\nRIAL', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 6, name: 'V4_SanMod_Bricks', displayName: 'BUILD\nYOUR\nBRICKS', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 7, name: 'V4_SanMod_Violet', displayName: 'DREAM\nIN\nVIOLET', generatedTextureObjects: undefined, objectsToHide: undefined},
    {id: 8, name: 'V4_SanMod_Mind', displayName: 'FREE\nYOUR\nMIND', generatedTextureObjects: undefined, objectsToHide: undefined}],
    objects: [],
    detailViews: [{id: 0,
      camera: { x: 40, y: 20, z: 110},
      target: {x: -50, y: -50, z: 0},
  ...
  ANIMATING = true;  
  new Promise( () => {
    loadModel("Design_4_obj/Betonboden",false, 0, 0, false, 0, true);
    loadModel("Design_1_obj/Betonboden",false, 0, 0, false, 0, true);
    loadModel("Design_2_obj/Betonboden",false, 0, 0, false, 0, true);
    loadModel("Design_3_obj/Betonboden",false, 0, 0, false, 0, true);
  } );
  generateDesign(4);
  generateDesign(1);
  generateDesign(2);
...
function generateDesign(id) {
    ...
    switch (id) {
        case 1:
          ...
          loadModel("Design_1_glb/restliche_Verkleidung_Dusche", false, 0, 0, false,17,false,{value: true, childrenId: 0, hideAll: true, except: ['V1_SanMod_Nature', 'V1_SanMod_Stripes', 'V1_SanMod_Woods', 'V1_SanMod_Industrial', 'V1_SanMod_Bricks','V1_SanMod_Violet','V1_SanMod_Mind']},'RIGHT',null, '6.6 restliche Verkleidung einbauen', true, 3000, 10);
          ...
          loadModel("Design_1_glb/restliche_Verkleidung_rechts", false, 0, 0, false,21,false,{value: true, childrenId: 0, hideAll: true, except: ['V1_SanMod_Nature', 'V1_SanMod_Stripes', 'V1_SanMod_Woods', 'V1_SanMod_Industrial', 'V1_SanMod_Bricks','V1_SanMod_Violet','V1_SanMod_Mind']},'RIGHT',null, null, false, 4000, 10);
          loadModel("Design_1_glb/restliche_Verkleidung_links", false, 0, 0, false,22,false,{value: true, childrenId: 0, hideAll: true, except: ['V1_SanMod_Nature', 'V1_SanMod_Stripes', 'V1_SanMod_Woods', 'V1_SanMod_Industrial', 'V1_SanMod_Bricks','V1_SanMod_Violet','V1_SanMod_Mind']},'LINKS',null, null, true, 4000, 10);
        ...
        detailViews.push({id: 1, 
          ...
          loadModel("Design_2_glb/restliche_Verkleidung_Dusche", false, 0, 0, true,14,false,{value: true, childrenId: 0, hideAll: false, except: ['V2_SanMod_Nature','V2_SanMod_Stripes','V2_SanMod_Woods', 'V2_SanMod_Industrial', 'V2_SanMod_Bricks','V2_SanMod_Violet','V2_SanMod_Mind']},'FRONT',null, '6.3 Verkleidung Dusche', true, 4000, 10);
        ...
        case 3:
          ...
          numberOfModels = 29;
            ...
            loadModel("Design_3_glb/restliche Verkleidung_rechts", false, 0, 0, false,17,false,{value: true, childrenId: 0, hideAll: false, except: ['V3_SanMod_Nature','V3_SanMod_Stripes','V3_SanMod_Woods','V3_SanMod_Industrial', 'V3_SanMod_Bricks','V3_SanMod_Violet','V3_SanMod_Mind']},'RIGHT',null, '9. restliche Verkleidungen einbauen', false, 4000, 10, true, 1);
        ...
        case 4:
            ...
            loadModel("Design_4_glb/restliche_Verkleidung_Dusche", false, 0, 0, false,17,false,{value: false, childrenId: 0, except: ['V4_SanMod_Nature','V4_SanMod_Stripes','V4_SanMod_Woods', ,'V4_SanMod_Industrial', 'V4_SanMod_Bricks','V4_SanMod_Violet','V4_SanMod_Mind']},'RIGHT',null, '6.6 Dusche Verkleidung', true, 4000, 20);  
